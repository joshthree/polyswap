...
public class MainExperiment3 {
	...
	public static void main(String[] args) throws Exception {
		...
		ECPoint h1,h2;
		h1 = signer.generateSecondGenerator(rnd, in, out);
		...
		if(id ==1 ) {	
			...
			System.out.println("phi1: " + btcja.getPhi());
			System.out.println("phi2: " + b2);
			Transaction tx = clB.getDepositTransaction();
			...
			System.out.println("phi1: " + a2);
			System.out.println("phi2: " + btcja.getPhi());
